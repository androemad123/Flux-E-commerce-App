    ...
    OrderDetails(
      ...
      products: [
        ...
        Product(
          ...
          ProductQuantity: 1,
          ProductPrice: 39.99,
          ProductImageURL: ["https://example.com/keyboard.jpg"],
        ),
      ],
    ),
    OrderDetails(
      ...
      products: [
        Product(
          ...
          ProductDescription: "Latest Android smartphone with 128GB storage",
          ProductQuantity: 1,
          ProductPrice: 99.99,
        ...
        Product(
          ...
          ProductDescription: "Shockproof protective phone case",
          ProductQuantity: 2,
          ProductPrice: 24.99,
    ...
    OrderDetails(
      ...
      products: [
        Product(
          ...
          ProductQuantity: 1,
          ProductPrice: 49.99,
          ProductImageURL: ["https://example.com/speaker.jpg"],
        ),
      ],
    ),
  ];
