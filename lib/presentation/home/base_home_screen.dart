...
class _BaseHomeScreenState extends State<BaseHomeScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  RecommendedSection(),
                  SizedBox(height: 20.h),
                  TopCollectionSection(selectedCategory: categoryNames[selectedIndex]),
                ],
              ),
            ),
          );
      ...
      child: ListView(
        children: [
          ...
          Padding(
            ...
            child: ListTile(title: Text('OTHER', style: TextStyle(fontSize: FontSize.s18))),
          ),
  ...
  Widget _buildDrawerItem(IconData icon, String title, VoidCallback onTap) {
    return ListTile(
      leading: Icon(icon, size: AppSize.s30),
      title: Text(
        title,
        style: TextStyle(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.wb_sunny_outlined, size: AppSize.s28, color: Colors.black),
                        SizedBox(width: 10),
                        Text(
                          'Light',
                          style: TextStyle(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Icon(Icons.dark_mode_outlined, size: AppSize.s28, color: Colors.black),
                        SizedBox(width: 10),
                        Text(
                          'Dark',
                          style: TextStyle(
